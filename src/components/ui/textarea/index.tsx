...
const textareaStyle = tva({
	base: 'w-full h-[200px] border border-outline rounded-xl data-[hover=true]:border-outline data-[focus=true]:border-primary data-[focus=true]:data-[hover=true]:border-primary data-[disabled=true]:opacity-40 data-[disabled=true]:bg-background data-[disabled=true]:data-[hover=true]:border-outline',
...
const textareaInputStyle = tva({
	base: 'p-2 web:outline web:outline-none flex-1 color-typography align-text-top placeholder:text-typography web:cursor-text web:data-[disabled=true]:cursor-not-allowed',
	parentVariants: {
		size: {
			sm: 'text-sm',
			md: 'text-base',
