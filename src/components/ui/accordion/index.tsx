...
const accordionTitleTextStyle = tva({
	base: 'text-typography font-bold flex-1 text-left',
	parentVariants: {
		size: {
			sm: 'text-sm',
			md: 'text-base',
...
const accordionTriggerStyle = tva({
	base: 'w-full flex-row justify-between items-center web:outline-none focus:outline-none data-[disabled=true]:opacity-40 data-[disabled=true]:cursor-not-allowed data-[focus-visible=true]:bg-background',
});
