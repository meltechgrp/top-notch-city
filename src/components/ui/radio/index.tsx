...
const radioIndicatorStyle = tva({
	base: 'justify-center items-center bg-transparent border-outline-400 border-2 rounded-full data-[focus-visible=true]:web:outline-2 data-[focus-visible=true]:web:outline-primary data-[focus-visible=true]:web:outline data-[checked=true]:border-primary data-[checked=true]:bg-transparent data-[hover=true]:border-outline data-[hover=true]:bg-transparent data-[hover=true]:data-[checked=true]:bg-transparent data-[hover=true]:data-[checked=true]:border-primary data-[hover=true]:data-[invalid=true]:border-error data-[hover=true]:data-[disabled=true]:opacity-40 data-[hover=true]:data-[disabled=true]:border-outline-400 data-[hover=true]:data-[disabled=true]:data-[invalid=true]:border-error-400 data-[active=true]:bg-transparent data-[active=true]:border-primary-800 data-[invalid=true]:border-error data-[disabled=true]:opacity-40 data-[disabled=true]:data-[checked=true]:border-outline-400 data-[disabled=true]:data-[checked=true]:bg-transparent data-[disabled=true]:data-[invalid=true]:border-error-400',
	parentVariants: {
		size: {
			sm: 'h-4 w-4',
			md: 'h-5 w-5',
...
const radioLabelStyle = tva({
	base: 'text-typography data-[checked=true]:text-typography data-[hover=true]:text-typography data-[hover=true]:data-[disabled=true]:text-typography data-[hover=true]:data-[disabled=true]:data-[checked=true]:text-typography data-[active=true]:text-typography data-[active=true]:data-[checked=true]:text-typography data-[disabled=true]:opacity-40 web:select-none',
	parentVariants: {
		size: {
			'2xs': 'text-2xs',
			xs: 'text-xs',
