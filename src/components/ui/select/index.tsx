...
const selectIconStyle = tva({
  base: "text-typography fill-none",
  parentVariants: {
    size: {
      "2xs": "h-3 w-3",
      xs: "h-3.5 w-3.5",
...
const selectTriggerStyle = tva({
  base: "border border-outline rounded flex-row items-center overflow-hidden data-[hover=true]:border-outline data-[focus=true]:border-primary data-[disabled=true]:opacity-40 data-[disabled=true]:data-[hover=true]:border-outline",
  variants: {
    size: {
      xl: "h-12",
      lg: "h-11",
    ...
    variant: {
      underlined:
        "border-0 border-b rounded-none data-[hover=true]:border-primary data-[focus=true]:border-primary data-[focus=true]:web:shadow-[inset_0_-1px_0_0] data-[focus=true]:web:shadow-primary data-[invalid=true]:border-error data-[invalid=true]:web:shadow-error",
      outline:
        "data-[focus=true]:border-primary data-[focus=true]:web:shadow-[inset_0_0_0_1px] data-[focus=true]:data-[hover=true]:web:shadow-primary-600 data-[invalid=true]:web:shadow-[inset_0_0_0_1px] data-[invalid=true]:border-error data-[invalid=true]:web:shadow-error data-[invalid=true]:data-[hover=true]:border-error",
      rounded:
        "rounded-full data-[focus=true]:border-primary data-[focus=true]:web:shadow-[inset_0_0_0_1px] data-[focus=true]:web:shadow-primary data-[invalid=true]:border-error data-[invalid=true]:web:shadow-error",
    },
  },
});

const selectInputStyle = tva({
  base: "py-auto px-3 placeholder:text-typography web:w-full h-full text-typography pointer-events-none web:outline-none ios:leading-[0px]",
  parentVariants: {
    size: {
      xl: "text-xl",
      lg: "text-lg",
