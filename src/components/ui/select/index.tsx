...
const selectIconStyle = tva({
	base: 'text-background fill-none',
	parentVariants: {
		size: {
			'2xs': 'h-3 w-3',
			xs: 'h-3.5 w-3.5',
...
const selectTriggerStyle = tva({
	base: 'border border-background rounded flex-row items-center overflow-hidden data-[hover=true]:border-outline data-[focus=true]:border-primary data-[disabled=true]:opacity-40 data-[disabled=true]:data-[hover=true]:border-background',
	variants: {
		size: {
			xl: 'h-12',
			lg: 'h-11',
