...
const actionsheetContentStyle = tva({
	base: 'items-center rounded-tl-3xl rounded-tr-3xl p-2 bg-background web:pointer-events-auto web:select-none shadow-lg',
});

const actionsheetItemStyle = tva({
	base: 'w-full flex-row items-center p-3 rounded-sm data-[disabled=true]:opacity-40 data-[disabled=true]:web:pointer-events-auto data-[disabled=true]:web:cursor-not-allowed hover:bg-background-50 active:bg-background data-[focus=true]:bg-background web:data-[focus-visible=true]:bg-background data-[checked=true]:bg-background',
});
...
const actionsheetDragIndicatorStyle = tva({
	base: 'w-16 h-1 bg-background rounded-full',
});
...
const actionsheetSectionHeaderTextStyle = tva({
	base: 'leading-5 font-bold font-heading my-0 text-typography p-3 uppercase',
	variants: {
		isTruncated: {
			true: '',
		},
