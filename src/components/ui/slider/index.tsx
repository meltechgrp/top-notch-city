...
const sliderThumbStyle = tva({
  base: "bg-primary absolute rounded-full data-[focus=true]:bg-primary data-[active=true]:bg-primary data-[hover=true]:bg-primary data-[disabled=true]:bg-primary web:cursor-pointer web:data-[active=true]:outline web:data-[active=true]:outline-4 web:data-[active=true]:outline-primary shadow-hard-1",
...
const sliderTrackStyle = tva({
  base: "bg-background rounded-lg overflow-hidden",
  parentVariants: {
    orientation: {
      horizontal: "w-full",
      vertical: "h-full",
