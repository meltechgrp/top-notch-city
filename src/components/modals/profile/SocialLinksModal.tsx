...
export function SocialLinkModal({
  ...
  return (
    <Modal visible={visible} transparent animationType="slide">
      <View className="flex-1 justify-end android:justify-center bg-black/80">
        ...
        >
          ...
          >
            <Text className="text-center text-xl font-medium mb-4">
              {platform}
            </Text>
            ...
            <TextInput
              ...
              placeholder={`Enter ${platform} link, i.e https://`}
              keyboardType="url"
